...
<head>
    ...
    <!-- Font Icon -->
    <link rel="stylesheet" href="{{asset('fonts/StartEndWordFonts/material-icon/css/material-design-iconic-font.min.css')}}">

    <!-- Main css -->
    <link rel="stylesheet" href="{{asset('css/StartEndWordCss/style.css')}}">
</head>
<body>
    ...
    <!-- JS -->
    <script src="{{asset('StartEndWorkJs\vendor\jquery\jquery.min.js')}}"></script>
